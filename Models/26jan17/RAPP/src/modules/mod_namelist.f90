...
module mod_namelist
   ...
   type namelist_struct
      ...
      real                    :: dtinc     ! Time increment for rad. interp. integration
      ...
      integer                 :: ndownscal ! # of downscaled precipitation realisations.
      real, dimension(maxpdf) :: frac_u    ! Fractional PDF for each block of time of a day
                                           !   for each month.
   ...
   subroutine initialise_namelist()
      ...
      !----- Initialise the downscaling parameters. ---------------------------------------!
      nl%ndownscal    = -huge(1)
      nl%frac_u       = -huge(1.)
      return
