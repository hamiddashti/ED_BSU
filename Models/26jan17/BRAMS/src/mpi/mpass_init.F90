...
subroutine masterput_nl(master_num)
   ...
   call MPI_Bcast(ZB_NUDGE_UV,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ZB_NUDGE_TH,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ZB_NUDGE_PI,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ZB_NUDGE_RT,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ZB_NUDGE_CO2,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(WT_NUDGE_RC,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ZB_NUDGE_RC,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(CPTIME,1,MPI_DOUBLE_PRECISION,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(IUPMETHOD,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ILOUREC,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(CAP_MAXS,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr) 
   call MPI_Bcast(CLD2PREC,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr) 
   call MPI_Bcast(ZKBMAX,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)   
   call MPI_Bcast(ZCUTDOWN,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr) 
   call MPI_Bcast(Z_DETR,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)   
   call MPI_Bcast(MAX_HEAT,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr) 
   call MPI_Bcast(CLOSURE_TYPE,2,MPI_CHARACTER,mainnum,MPI_COMM_WORLD,ierr) 
   call MPI_Bcast(MAXENS_LSF,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(MAXENS_EFF,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(MAXENS_CAP,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(LC_GAMM,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(NDTVEG,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
...
subroutine nodeget_nl
   ...
   call MPI_Bcast(ZB_NUDGE_UV,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ZB_NUDGE_TH,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ZB_NUDGE_PI,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ZB_NUDGE_RT,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ZB_NUDGE_CO2,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(WT_NUDGE_RC,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ZB_NUDGE_RC,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(CPTIME,1,MPI_DOUBLE_PRECISION,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(IUPMETHOD,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(ILOUREC,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(CAP_MAXS,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr) 
   call MPI_Bcast(CLD2PREC,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr) 
   call MPI_Bcast(ZKBMAX,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)   
   call MPI_Bcast(ZCUTDOWN,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr) 
   call MPI_Bcast(Z_DETR,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)   
   call MPI_Bcast(MAX_HEAT,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr) 
   call MPI_Bcast(CLOSURE_TYPE,2,MPI_CHARACTER,master_num,MPI_COMM_WORLD,ierr) 

   call MPI_Bcast(MAXENS_LSF,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(MAXENS_EFF,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(MAXENS_CAP,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(LC_GAMM,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   ...
   call MPI_Bcast(NDTVEG,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
