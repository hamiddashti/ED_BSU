...
module mem_globrad  
   ...
   real                                :: alb_tot
   real                                :: tiru
   real, dimension(:)    , allocatable :: firu
   real, dimension(:)    , allocatable :: firn
   real, dimension(:)    , allocatable :: fslu_toa
   real, dimension(:)    , allocatable :: fsld_toa
   real, dimension(:)    , allocatable :: fslu_diff_gnd
   real, dimension(:)    , allocatable :: fsld_diff_gnd
   real, dimension(:)    , allocatable :: fsld_beam_gnd
   real, dimension(:)    , allocatable :: alb_toa
   real, dimension(:)    , allocatable :: fupbs
   real, dimension(:)    , allocatable :: fdownbs
   real, dimension(:)    , allocatable :: fnetbs
   real, dimension(:)    , allocatable :: fupbi
   real, dimension(:)    , allocatable :: fdownbi
   real, dimension(:)    , allocatable :: fnetbi
   ...
   subroutine initial_definitions_globrad()
     ...
     allocate(firu                       (nir ))
     allocate(firn                       (nir ))
     allocate(fslu_toa                   (nsol))
     allocate(fsld_toa                   (nsol))
     allocate(fslu_diff_gnd              (nsol))
     allocate(fsld_diff_gnd              (nsol))
     allocate(fsld_beam_gnd              (nsol))
   ...
   subroutine final_definitions_globrad()
     ...
     deallocate(fslu_toa)
     deallocate(fsld_toa)
     deallocate(fslu_diff_gnd)
     deallocate(fsld_diff_gnd)
     deallocate(fsld_beam_gnd)
     deallocate(alb_toa)
     deallocate(fupbs)
     deallocate(fdownbs)
     deallocate(fnetbs)
...
ta=  (/ 1.500   ,  1.500   ,  1.500   ,  1.500   ,  1.500   ,  1.500,  &
        ...
        0.700   ,  0.700   ,  0.700   ,  0.700   ,  0.700   ,  0.700,  &
        0.700   ,  0.700   ,  0.700   ,  0.700   ,  0.700   ,  0.700,  &
        0.700   ,  0.700   ,  0.700   ,  0.700   ,  0.700   ,  0.240,  &
        0.240   ,  0.240   ,  0.240   ,  0.240   ,  0.240   ,  0.240,  &
        0.240   ,  0.240   ,  0.240   ,  0.240   ,  0.240   ,  0.240,  &
        0.240   ,  0.240   ,  0.240   ,  0.240   ,  0.240   ,  0.270,  &
...
tb=  (/ 0.500   ,   0.500  ,   0.500  ,   0.500  ,  0.500   ,  0.500, &
        ...
        1.130   ,   1.130  ,   1.130  ,   1.130  ,  1.130   ,  1.130, &
        1.130   ,   1.130  ,   1.130  ,   1.130  ,  2.000   ,  2.000, &
        2.000   ,   2.000  ,   2.000  ,   2.000  ,  2.000   ,  2.000, &
        2.000   ,   2.000  ,   2.000  ,   2.000  ,  2.000   ,  2.000, &
        2.000   ,   2.000  ,   2.000  ,   2.000  ,  2.000   ,  2.000, &
        2.000   ,   2.000  ,   2.000  ,   2.000  ,  2.000   , -0.120, &
...
tib= (/  254.8	,  254.8   ,  254.8   ,  254.8   ,  254.8   ,  254.8, &
