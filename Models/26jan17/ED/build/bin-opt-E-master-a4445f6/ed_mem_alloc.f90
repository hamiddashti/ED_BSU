...
module ed_mem_alloc
   ...
   !---------------------------------------------------------------------------------------!
   !     Subroutine that allocates most structures in ED-2.2.                              !
   !---------------------------------------------------------------------------------------!
   ...
   !---------------------------------------------------------------------------------------!
   ! Changed this part. The structure will not be allocated at the nodes at this moment,   !
   ! and even at the master node we will have deallocated to reallocate with the node size !
   ! rather than the full domain. Also, we will need to use this structure even for latlon !
   ! grid, because it will be used to assign the polygon information.                      !
   !---------------------------------------------------------------------------------------!
