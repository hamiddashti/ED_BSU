...
declare -a SITEGRP2=(TNF ATA PET HIM HIP RJG)
declare -a SITETAG1=(m34 s67 har pdg ton cax)
declare -a SITETAG2=(tnf ata pet him hip rjg)


declare -a VARGRP1=(IED_INIT_MODE INTEGRATION_SCHEME \
                      POI_LAT POI_LON ISOILFLG ISOILCOL \
                      NZG ISOILBC IBIGLEAF IBRANCH_THERMO IALLOM IGRASS \
                      IPHEN_SCHEME CROWN_MOD DECOMP_SCHEME H2O_PLANT_LIM)

declare -a VARGRP2=(IDDMORT_SCHEME THETACRIT INCLUDE_FIRE IANTH_DISTURB \
                   ICANTURB IPERCOL MAXSITE MAXPATCH MAXCOHORT TREEFALL_DISTURBANCE_RATE \
                   IMETAVG IMETRAD DT_CENSUS IDETAILED PATCH_KEEP)


declare -a VNAME1=(INIT_MODE INTEGRATION LAT LON ISOILFLG ISOILCOL \
                      NZG ISOILBC IBIGLEAF IBRANCH IALLOM IGRASS \
                      IPHEN CROWNMOD DECOMP_SCHEME H2O_PLANT_LIM)

declare -a VNAME2=(IDDMORT_SCHEME THETACRIT INCLUDE_FIRE IANTH_DISTURB \
                   ICANTURB IPERCOL MAXSITE MAXPATCH MAXCOHORT TREEFALL_RATE \
                   IMETAVG IMETRAD DT_CENSUS IDETAILED PATCH_KEEP)
